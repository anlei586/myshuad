	...
	tab_menu:{
		me:{
			lab:{
				...
				ok_paypal_to_server:"提交USDT-TRC20钱包地址", Please_Input_Paypal_Account:"请输入USDT-TRC20钱包地址",Please_Input_NewPaypal_Account:"请输入新的USDT-TRC20钱包地址",
				ok_isdraw_money_to_paypal:"提现到USDT-TRC20钱包", please_input_confri_data:"请填写正确的字符", ok_draw_money_complete:"请耐心等待管理员审核。",
				TIP_NOT_MONEY_DRAW:"没有可提现的余额", TIP_MONEY_DRAW_TIME:"提现时间:周二和周五", again_onec_buy:"兑换优惠券", again_onec_buy2:"整额兑换优惠券", coupons_tip:"优惠券", copy_coupons_tip:"复制优惠券", split_coupons_tip:"拆分优惠券",
	...
	tab_menu:{
		me:{
			lab:{
				...
				ok_paypal_to_server:"Submit USDT-TRC20 wallet address", Please_Input_Paypal_Account:"please input USDT-TRC20 wallet address",Please_Input_NewPaypal_Account:"please input New USDT-TRC20 wallet address",
				ok_isdraw_money_to_paypal:"Withdraw cash to your USDT-TRC20 wallet address", please_input_confri_data:"Please fill in the correct characters", ok_draw_money_complete:"Please wait patiently for the administrator review.",
				TIP_NOT_MONEY_DRAW:"There is no cash balance", TIP_MONEY_DRAW_TIME:"Withdrawal time: Tuesday、Friday", again_onec_buy:"Exchange Coupons", again_onec_buy2:"Full exchange coupon", coupons_tip:"Coupons", copy_coupons_tip:"Copy Coupons", split_coupons_tip:"Split Coupons",
